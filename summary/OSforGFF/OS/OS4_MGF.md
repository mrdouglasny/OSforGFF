...
**Length**: 282 lines, 1 definition + 10 lemmas

---

## Time Translation Infrastructure

### [`timeTranslationSchwartzℂ_decompose_fst`](../../../OSforGFF/OS/OS4_MGF.lean#L80) — Lemma
...
### [`timeTranslationSchwartzℂ_decompose_snd`](../../../OSforGFF/OS/OS4_MGF.lean#L89) — Lemma
...
### [`timeTranslationDistribution_pairingℂ`](../../../OSforGFF/OS/OS4_MGF.lean#L99) — Lemma
...
**Proof uses**: [`timeTranslationSchwartzℂ_decompose_fst`](../../../OSforGFF/OS/OS4_MGF.lean#L80),
[`timeTranslationSchwartzℂ_decompose_snd`](../../../OSforGFF/OS/OS4_MGF.lean#L89),
`timeTranslationDistribution_apply`

---

### [`continuous_distributionPairingℂ_timeTranslation`](../../../OSforGFF/OS/OS4_MGF.lean#L116) — Lemma

**Statement**: The map $s \mapsto \langle T_s \omega, g \rangle_{\mathbb{C}}$ is
continuous in $s$.

**Proof uses**: [`timeTranslationDistribution_pairingℂ`](../../../OSforGFF/OS/OS4_MGF.lean#L99),
[`timeTranslationSchwartzℂ_decompose_fst`](../../../OSforGFF/OS/OS4_MGF.lean#L80),
[`timeTranslationSchwartzℂ_decompose_snd`](../../../OSforGFF/OS/OS4_MGF.lean#L89),
...
### [`timeTranslationE`](../../../OSforGFF/OS/OS4_MGF.lean#L147) — Definition
...
### [`euclidean_action_timeTranslationE`](../../../OSforGFF/OS/OS4_MGF.lean#L151) — Lemma
...
### [`freeCovarianceℂ_bilinear_timeTranslation_invariant`](../../../OSforGFF/OS/OS4_MGF.lean#L167) — Lemma

**Statement**: The GFF complex covariance bilinear form is invariant under simultaneous
time translation of both arguments:
$$C(T_t f, T_t g) = C(f, g).$$

**Proof uses**: [`euclidean_action_timeTranslationE`](../../../OSforGFF/OS/OS4_MGF.lean#L151),
...
### [`gff_mgf_formula`](../../../OSforGFF/OS/OS4_MGF.lean#L178) — Lemma
...
**Proof uses**: [`GFFIsGaussian.gff_complex_characteristic_OS0`](../../../OSforGFF/Measure/IsGaussian.lean#L211),
...
### [`gff_generating_time_invariant`](../../../OSforGFF/OS/OS4_MGF.lean#L209) — Lemma
...
**Proof uses**: [`gff_mgf_formula`](../../../OSforGFF/OS/OS4_MGF.lean#L178),
[`freeCovarianceℂ_bilinear_timeTranslation_invariant`](../../../OSforGFF/OS/OS4_MGF.lean#L167)

---

## Joint MGF Factorization

### [`gff_joint_mgf_factorization`](../../../OSforGFF/OS/OS4_MGF.lean#L222) — Lemma
...
**Proof uses**: [`gff_mgf_formula`](../../../OSforGFF/OS/OS4_MGF.lean#L178),
[`gff_two_point_equals_covarianceℂ_free`](../../../OSforGFF/Measure/IsGaussian.lean#L454),
...
### [`exp_sub_one_bound_general`](../../../OSforGFF/OS/OS4_MGF.lean#L254) — Lemma
