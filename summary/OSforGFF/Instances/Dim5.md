...
[`schwingerIntegral_eq_besselK`](../../../OSforGFF/General/BesselK.lean#L137). The evaluation needs the
...
[`gaussian_moment2`](../../../OSforGFF/Instances/Dim5.lean#L32)). The generic master theorem applies in every
dimension $d \ge 2$, so the file only needs to supply the `Fact (2 ≤ 5)` instance
([`instFactTwoLeFive`](../../../OSforGFF/Instances/Dim5.lean#L154)) and the
[`GFFPropagator 5 m`](../../../OSforGFF/Instances/Dim5.lean#L158) instance.

## Status

**Main result**: Fully proven (0 sorries).

**Length**: 164 lines, 2 definition(s) + 3 theorem(s)/lemma(s)
...
**Proof uses**: [`besselK`](../../../OSforGFF/General/BesselK.lean#L38),
...
[`schwingerIntegral_eq_besselK`](../../../OSforGFF/General/BesselK.lean#L137),
...
### [`instFactTwoLeFive`](../../../OSforGFF/Instances/Dim5.lean#L154) — Definition *(instance)*
...
**Informal**: The order bound $2 \le 5$, needed for the time/space split in the generic covariance
construction.

---

### [`instGFFPropagatorDim5`](../../../OSforGFF/Instances/Dim5.lean#L158) — Definition *(instance)*
